    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">About ZenForce TaijiQuan</h1>
          <p className="text-xl text-gray-600">Discover our journey, philosophy, and commitment to wellness</p>
        </div>
          ...
          <div className="flex justify-center">
            <div className="bg-white shadow-lg rounded-lg p-6 max-w-md w-full">
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Our Instructors</h3>
                  <p className="text-gray-600">Experienced and Certified Professionals</p>
                </div>
              </div>
