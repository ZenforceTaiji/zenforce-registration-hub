      ...
      <Dialog open={imageDialogOpen} onOpenChange={setImageDialogOpen}>
        <DialogContent className="sm:max-w-3xl">
          <DialogHeader>
            ...
            <DialogDescription>
              {selectedImage?.date} • <Badge variant="outline">{selectedImage?.category}</Badge>
            </DialogDescription>
          </DialogHeader>
        ...
        <DialogContent className="sm:max-w-3xl">
          <DialogHeader>
            ...
            <DialogDescription className="flex items-center gap-2">
              {selectedVideo?.date} • <Badge variant="outline">{selectedVideo?.category}</Badge>
            </DialogDescription>
          </DialogHeader>
